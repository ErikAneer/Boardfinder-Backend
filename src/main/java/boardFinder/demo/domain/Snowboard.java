...
public class Snowboard implements Serializable {
    ...
    public Snowboard(Brand boardBrand, String model, Gender boardGender, double stanceSetBack, Bend boardBend,
            Shape boardShape, Flex boardFlex, Core core, int stiffness, String imagePath, String introDescription, String description) {
